...
(custom-set-variables
 ...
 '(package-selected-packages
   '(toc-org ivy-posframe smex ivy-rich counsel vterm-toggle projectile emmet-mode lsp-pyright company lsp-ui lsp-mode which-key neotree peep-dired dired-open all-the-icons-dired gcmh general evil-nerd-commenter exwm vterm doom-themes use-package org-bullets gruvbox-theme evil-org doom-modeline dashboard)))
...
(nvmap :prefix "SPC"
  ...
  "v t"   '(vterm-toggle :which-key "Toggle Vterm"))
...
;; (add-hook 'vterm-mode-hook (lambda () (setq turn-off-evil-mode 1)))
...
(setq mouse-wheel-scroll-amount '(8 ((shift) . 8))) ;; how many lines at a time
